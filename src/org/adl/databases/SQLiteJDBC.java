...
public class SQLiteJDBC{
    public static void main(String args[]){
        ...
        try{
            ...
            sqlStuff1.add("CREATE TABLE IF NOT EXISTS CourseInfo(CourseID CHAR(255) PRIMARY KEY,CourseTitle CHAR(200),ImportDateTime CHAR(50),Active INTEGER CHECK(Active IN (0,1)),Start INTEGER CHECK(Start IN (0,1)),TOC INTEGER CHECK(TOC IN (0,1)));");
