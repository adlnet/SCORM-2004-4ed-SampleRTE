...
public class DOMTreeUtility
{
      ...
      if( iNode != null )
      {
         ...
         for ( int k = 0; k < numAttr; k++ )
         {
            ...
            if ( currentNodeName.equalsIgnoreCase(iAttributeName) )
            {
               ...
               // if the attribute is of type xs:ID or ID, we must process it first
               if ( iAttributeName.equals("identifiier") || iAttributeName.equals("default") )
               {
                                           ...
                                           String iAttributeName )
   {
      ...
      if( theAttribute != null )
      {
         ...
         // We must process all attributes of type xs:ID or ID
