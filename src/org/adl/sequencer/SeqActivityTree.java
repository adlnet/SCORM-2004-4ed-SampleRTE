...
public class SeqActivityTree implements Serializable
{
   ...
   /**
    * The location of the data store collection.
    */
   public static String dataStoreLoc;
   
   /**
    * The data store collection.
    */
   public static HashMap dsMap = new HashMap();
   ...
   */
   ...
   /**
    * attribute value (sharedDataGlobalToSystem) from manifest
    * says if the data element data should be preserved for a learner 
    * throughout lifetime of the course 
    */
    ...
    * 
    * @param iAttributeValue Whether the data store should persist for all attempts.
    */
   public void setDataScopedForAllAttempts(boolean iAttributeValue)
   {
      mDataScopedForAllAttempts  = iAttributeValue;
   }
   
   /**
    * Indicates if the data store collection is persisted for all attempts.
    * 
    * @return Whether or not the data store collection should be persisted.
    */
   public boolean dataScopedForAllAttempts()
   {
      return mDataScopedForAllAttempts;
   }
   
   /**
    * Gets the activity map.
    * 
    * @return Map of the activities.
    */
